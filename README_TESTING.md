<!-- TOC -->
* [OpenStudioLandscapes-Ayon](#openstudiolandscapes-ayon)
<!-- TOC -->
...
Instead of the [`definitions.py`](src/OpenStudioLandscapes/Ayon/definitions.py), 
the accompanying [`workspace.yaml`](workspace.yaml) loads 
the [`_definitions_with_upstream_specs.py`](src/OpenStudioLandscapes/Ayon/_definitions_with_upstream_specs.py) 
which also contains 
